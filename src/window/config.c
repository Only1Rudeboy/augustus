...
static config_widget ui_widgets_by_category[CATEGORY_UI_COUNT][MAX_WIDGETS] = {
    ...
    // Building
    {
        ...
        {TYPE_CHECKBOX, CONFIG_UI_DISPLAY_PROFILER, TR_CONFIG_DISPLAY_PROFILER, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},
        {TYPE_CHECKBOX, CONFIG_UI_WALKER_DEBUG, TR_CONFIG_WALKER_DEBUG, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},
        {TYPE_CHECKBOX, CONFIG_UI_HOUSE_DIAGNOSE, TR_CONFIG_HOUSE_DIAGNOSE, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},
...
static config_widget city_mgmt_widgets_by_category[CATEGORY_CITY_COUNT][MAX_WIDGETS] = {
    // Storage
    {
        ...
        {TYPE_CHECKBOX, CONFIG_GP_CH_STORAGE_ACCEPTS_WHEN_STAFFED, TR_CONFIG_STORAGE_ACCEPTS_WHEN_STAFFED, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},
        {TYPE_NONE}
    },
    // Roads
    {
        ...
        {TYPE_CHECKBOX, CONFIG_GP_CH_BUILD_OVER_WALKERS, TR_CONFIG_BUILD_OVER_WALKERS, NULL, 0, 1, ITEM_BASE_H, CHECKBOX_MARGIN},
