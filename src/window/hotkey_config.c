...
static hotkey_widget hotkey_widgets[] = {
    ...
    {HOTKEY_BLUEPRINT_COPY, TR_HOTKEY_BLUEPRINT_COPY},
    {HOTKEY_BLUEPRINT_PASTE, TR_HOTKEY_BLUEPRINT_PASTE},
    {HOTKEY_BLUEPRINT_ROTATE, TR_HOTKEY_BLUEPRINT_ROTATE},
    {HOTKEY_BLUEPRINT_MIRROR, TR_HOTKEY_BLUEPRINT_MIRROR},
