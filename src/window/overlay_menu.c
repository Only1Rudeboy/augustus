...
static const overlay_menu_entry overlay_menu[] = {
    ...
    { OVERLAY_HOUSE_NEEDS, TR_OVERLAY_HOUSE_NEEDS, AUGUSTUS, NULL },
    { OVERLAY_HOUSE_FOOD, TR_OVERLAY_HOUSE_FOOD, AUGUSTUS, NULL },
    { OVERLAY_HOUSE_BATH, TR_OVERLAY_HOUSE_BATH, AUGUSTUS, NULL },
    { OVERLAY_HOUSE_ENTERTAINMENT_GAP, TR_OVERLAY_HOUSE_ENTERTAINMENT_GAP, AUGUSTUS, NULL },
