...
typedef enum {
    ...
    CONFIG_UI_EMPIRE_SMART_BORDER_PLACEMENT,
    ...
    CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_PLEBIANS,
    CONFIG_GP_CH_AUTO_CLEAR_TREES,
    CONFIG_GP_CH_HOUSING_DO_NOT_SPAWN_DOGS,
    ...
    CONFIG_UI_AUTO_CYCLE_TEMPLES,
    CONFIG_UI_AUTO_CYCLE_GARDENS,
    CONFIG_UI_DISPLAY_PROFILER,
    CONFIG_UI_WALKER_DEBUG,
    CONFIG_UI_HOUSE_DIAGNOSE,
    CONFIG_GP_CH_STORAGE_ACCEPTS_WHEN_STAFFED,
    CONFIG_GP_CH_BUILD_OVER_WALKERS,
    CONFIG_MAX_ENTRIES
} config_key;
