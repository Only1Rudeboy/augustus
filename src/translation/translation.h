...
typedef enum {
    ...
    TR_HOTKEY_BLUEPRINT_COPY,
    TR_HOTKEY_BLUEPRINT_PASTE,
    ...
    TR_CONFIG_DISPLAY_PROFILER,
    TR_CONFIG_WALKER_DEBUG,
    TR_CONFIG_HOUSE_DIAGNOSE,
    TR_CONFIG_STORAGE_ACCEPTS_WHEN_STAFFED,
    TR_CONFIG_BUILD_OVER_WALKERS,
    TR_OVERLAY_HOUSE_NEEDS,
    TR_TOOLTIP_OVERLAY_HOUSE_NEEDS_OK,
    TR_TOOLTIP_OVERLAY_HOUSE_NEEDS_BLOCKED,
    TR_OVERLAY_HOUSE_FOOD,
    TR_OVERLAY_HOUSE_BATH,
    TR_OVERLAY_HOUSE_ENTERTAINMENT_GAP,
    TR_TOOLTIP_OVERLAY_HOUSE_FOOD,
    TR_TOOLTIP_OVERLAY_HOUSE_BATH,
    TR_TOOLTIP_OVERLAY_HOUSE_ENTERTAINMENT_GAP,
    TR_HOTKEY_BLUEPRINT_ROTATE,
    TR_HOTKEY_BLUEPRINT_MIRROR,
    ...
    TR_CITY_WARNING_BLUEPRINT_FULL,
    TR_CITY_WARNING_BLUEPRINT_COPIED,
    TR_CITY_WARNING_BLUEPRINT_NO_BUILDINGS,
    TR_CITY_WARNING_BLUEPRINT_ROTATED,
    TR_CITY_WARNING_BLUEPRINT_MIRRORED,
    TR_CITY_WARNING_BLUEPRINT_EMPTY,
    TR_CITY_WARNING_BLUEPRINT_PASTE_FAILED,
    TR_CITY_WARNING_BLUEPRINT_PASTED,
    /* House diagnose UI */
    TR_HOUSE_READY_TO_EVOLVE,
    /* Storage status (warehouse/granary info) */
    TR_STORAGE_STATUS_NO_ROAD_ACCESS,
    TR_STORAGE_STATUS_EMPTYING_ALL,
    TR_STORAGE_STATUS_WORKERS_MAY_REFUSE,
    /* Industry cart logistics line */
    TR_INDUSTRY_CART_WAITING_UNDERSTAFFED,
    TR_INDUSTRY_CART_WAITING_NO_STORAGE,
    TR_INDUSTRY_CART_SEEKING_DESTINATION,
    TR_INDUSTRY_CART_TO_BUILDING,
    TR_INDUSTRY_CART_ACTIVE,
    TRANSLATION_MAX_KEY
} translation_key;
