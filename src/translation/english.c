...
static translation_string all_strings[] = {
    ...
    {TR_HOTKEY_BLUEPRINT_COPY, "Copy building blueprint (area drag or cursor)"},
    {TR_HOTKEY_BLUEPRINT_PASTE, "Paste building blueprint at cursor"},
    ...
    {TR_CONFIG_HOUSE_DIAGNOSE, "Show house upgrade checklist (why not evolve)"},
    {TR_CONFIG_STORAGE_ACCEPTS_WHEN_STAFFED, "Warehouses/granaries accept goods at 50%+ workers"},
    {TR_CONFIG_BUILD_OVER_WALKERS, "Allow building when walkers stand on the tile"},
    {TR_OVERLAY_HOUSE_NEEDS, "House needs (cannot evolve)"},
    {TR_TOOLTIP_OVERLAY_HOUSE_NEEDS_OK, "House can evolve (or max level)"},
    {TR_TOOLTIP_OVERLAY_HOUSE_NEEDS_BLOCKED, "House is missing services/goods to evolve"},
    {TR_OVERLAY_HOUSE_FOOD, "House food stocks"},
    {TR_OVERLAY_HOUSE_BATH, "House missing baths"},
    {TR_OVERLAY_HOUSE_ENTERTAINMENT_GAP, "House entertainment gap"},
    {TR_TOOLTIP_OVERLAY_HOUSE_FOOD, "Food stock relative to population"},
    {TR_TOOLTIP_OVERLAY_HOUSE_BATH, "Needs bathhouse access to evolve"},
    {TR_TOOLTIP_OVERLAY_HOUSE_ENTERTAINMENT_GAP, "Entertainment short of next level"},
    {TR_HOTKEY_BLUEPRINT_ROTATE, "Rotate building blueprint"},
    {TR_HOTKEY_BLUEPRINT_MIRROR, "Mirror building blueprint"},
    ...
    /* Blueprint stamp warnings */
    {TR_CITY_WARNING_BLUEPRINT_FULL, "Blueprint full (max buildings)"},
    {TR_CITY_WARNING_BLUEPRINT_COPIED, "Blueprint copied"},
    {TR_CITY_WARNING_BLUEPRINT_NO_BUILDINGS, "No buildings to copy"},
    {TR_CITY_WARNING_BLUEPRINT_ROTATED, "Blueprint rotated"},
    {TR_CITY_WARNING_BLUEPRINT_MIRRORED, "Blueprint mirrored"},
    {TR_CITY_WARNING_BLUEPRINT_EMPTY, "Blueprint empty — copy first"},
    {TR_CITY_WARNING_BLUEPRINT_PASTE_FAILED, "Could not paste blueprint"},
    {TR_CITY_WARNING_BLUEPRINT_PASTED, "Pasted %d/%d (%dx%d)"},
    /* House diagnose UI */
    {TR_HOUSE_READY_TO_EVOLVE, "Ready to evolve"},
    /* Storage status (warehouse/granary info) */
    {TR_STORAGE_STATUS_NO_ROAD_ACCESS, "No road access"},
    {TR_STORAGE_STATUS_EMPTYING_ALL, "Emptying all"},
    {TR_STORAGE_STATUS_WORKERS_MAY_REFUSE, "Workers %d%% — may refuse deliveries"},
    /* Industry cart logistics line */
    {TR_INDUSTRY_CART_WAITING_UNDERSTAFFED, "Cart waiting: storages understaffed"},
    {TR_INDUSTRY_CART_WAITING_NO_STORAGE, "Cart waiting: no accepting storage"},
    {TR_INDUSTRY_CART_SEEKING_DESTINATION, "Cart seeking destination"},
    {TR_INDUSTRY_CART_TO_BUILDING, "Cart -> building %u loads %u"},
    {TR_INDUSTRY_CART_ACTIVE, "Cart active (act %u)"}
};
